...
def get_bvh_data(bvh_dir=None):
    ...
    bvh_dir = bvh_dir or BVH_DIR

    for name, text in read_hand_bvh_files(bvh_dir):
...
def np_dataset(bvh_dir=None):

    data = [x for x in get_bvh_data(bvh_dir)]
