...
class TrainingLoop():
    ...
    def __init__(self, config, evaler, model_name):
        ...
        self.accum_steps = 1 #config.start_accum_steps
        self.running_mean = 0.
        self.test_losses = {}
    ...
    def _train_inner(self, info_bar, manager):
        ...
        show_images = (
            self.config.dataset.type == 'image'
            and self.config.display_images
            and (
